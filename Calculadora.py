## Main Imports
import sys, re, math, qdarktheme

from pathlib import Path
from PySide6.QtGui import QIcon, QKeyEvent
from PySide6.QtWidgets import QApplication, QMainWindow, QMessageBox, QVBoxLayout, QWidget, QLabel, QLineEdit, QGridLayout, QPushButton
from PySide6.QtCore import Qt,Signal, Slot

##############################################################################################################
## Variables
ROOT_DIR = Path(__file__).parent
FILES_DIR = ROOT_DIR / 'imgs'
WINDOW_ICON_PATH = FILES_DIR / 'Icone_app.png'
